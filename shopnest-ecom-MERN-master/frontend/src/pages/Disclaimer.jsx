...
const textualStyle = {
  ...
  background: '#a1a1dd',
  borderRadius: '16px',
  border: '1px solid rgba(53, 105, 200, 0.05)',
  lineHeight: '1.8',
  color: '#a1a1aa'
};
...
const Disclaimer = () => {
  return (
    <div style={textualStyle}>
      ...
      <h4 style={{ color: '#e2a981', marginTop: '25px', marginBottom: '10px' }}>1. Accuracy of Materials</h4>
      ...
      <h4 style={{ color: '#e3a87d', marginTop: '25px', marginBottom: '10px' }}>2. Payment Processing Restrictions</h4>
      <p style={{ marginBottom: '15px' }}>
